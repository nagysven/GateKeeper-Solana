...
class SavingsMetrics(BaseModel):
    """Cumulative fee, compute unit, and capital savings ledger statistics."""
    ...
    base_fee_saved_lamports: int = 0
    priority_fee_saved_lamports: int = 0
    jito_tip_saved_lamports: int = 0
    capital_saved_lamports: int = 0
    capital_saved_sol: float = 0.0
